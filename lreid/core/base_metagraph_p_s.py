...
class Base_metagraph_p_s(object):
    ...
    def __init__(self, config, loader):
        ...
        self.cnnbackbone = config.cnnbackbone #res50
    ...
    def _init_model(self):
        ...
        self.model_dict['metagraph'] = MetaGraph_fd(hidden_dim=self.model_dict['tasknet'].feature_dim, #2048
                                                 input_dim=self.model_dict['tasknet'].feature_dim, #2048
                                                 sigma=2.0,
                                                 proto_graph_vertex_num=self.config.p, # default=16, help='person count in a batch'
                                                 meta_graph_vertex_num=self.config.meta_graph_vertex_num) # 64 Vk
